...
export const DiaryStateDispatchContext = React.createContext();
...
function App() {
  ...
  return (
        ...
        <DiaryStateDispatchContext.Provider value={memoizedDispatches}>
            <div className="App">
                <DiaryEditor/>
        ...
        </DiaryStateDispatchContext.Provider>
